...
Откройте командную строку ("Win + R"; пропишите "cmd")и пропишите 
```bash
git clone https://github.com/SCOH-dev/AUTOVK_STEPS
```

У вас скопируются файлы проекта на рабочий стол (наверно)

Заходите в папку, копируете в нее путь
Прописываете в cmd
```bash
cd #путь к папке
```
...
Также у вас должен быть установлен python
